...
const Aboutus = () => {
    return (
        <Box>
            <Typography sx={{mt: '130px', textAlign: 'left', ml: '30px', fontFamily:'"Playfair Display",serif', color: '#303030', fontWeight: '700'}} variant="h2" gutterBottom component="div">
                    About Us
                </Typography>
            <Grid container spacing={2}>
                <Grid item xs={6} md={5}>
                <Typography sx={{ml: '30px', mt: '10px', textAlign: 'left'}} variant="caption" display="block" gutterBottom>
